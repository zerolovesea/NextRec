...
def main():
    ...
    sparse_features = [SparseFeature(name='user_id', embedding_name='user_emb',  vocab_size=user_id_vocab_size,  embedding_dim=embedding_dim),
                       SparseFeature(name='item_id', embedding_name='item_emb',  vocab_size=item_id_vocab_size,  embedding_dim=embedding_dim),]
